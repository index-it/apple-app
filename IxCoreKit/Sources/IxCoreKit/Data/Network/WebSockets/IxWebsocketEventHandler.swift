...
public class IxWebsocketEventHandler {
    ...
    func handleWebsocketEvent(data: WebsocketEventData) async throws {
        ...
        Task {
            ...
            case .listCreated:
                switch data.content {
                case let .listCreateOrUpdate(content):
            ...
            case .categoryCreated:
                switch data.content {
                case let .categoryCreateOrUpdate(content):
            ...
            case .categoryDeleted:
                switch data.content {
                case let .categoryDelete(content):
            ...
            case .itemCreated:
                switch data.content {
                case let .itemCreateOrUpdate(content):
            ...
            case .taskCreated:
                switch data.content {
                case let .taskCreateOrUpdate(content):
