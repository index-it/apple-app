...
struct SocialLoginScreen: View {
    ...
    private func loginWithGoogle() {
        ...
        _ = GIDConfiguration(clientID: "367062845885-0f6o9fj6cbebggmkbbrmseagbln33m2c.apps.googleusercontent.com")

        GIDSignIn.sharedInstance.signIn(withPresenting: presentingViewController) { res, _ in
...
private class SignInWithAppleController: NSObject, ASAuthorizationControllerDelegate {
